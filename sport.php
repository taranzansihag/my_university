...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">SPORTS</b></div>
	</div>
	
	
		<img src="university/images/sport.svg" class="img-responsive" width="100%">
	<br><br>
		
		<div class="row">
		<div class="col-sm-6" align="center">
		<br><br>
			<h1 class="w3-text-shadow" align="center"><b>Rather than a Problem<br>
			to be Solved , the World is a <br>
			joyful mystrey to<br> becontemplatedwith<br>
			gladness and praise.<br><br>
				<i class="w3-text-red">sport</i>
			</b></h1>
			...
			<div class="col-sm-6">
						...
						<?php
							...
							$rs=mysql_query("select * from sport");
							while($r=mysql_fetch_array($rs)){
						?>
							
							
					   <div class="row w3-text-shadow">
					
						<a href="university/sport/<?=$r[1]?>.pdf" style="text-decoration:none"><h2 class="w3-text-red w3-text-shadow"><b class="fa fa-circle" style="font-size:20px; width:50px"></b><?=$r[1]?></h2></a>
						</div>
					   <br>
					 <?php
