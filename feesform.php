...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">Student Detail</b></div>
	</div>
		...
		<h2 class="w3-text-shadow w3-border-bottom" align="center">WELCOME TO MY UNIVERSITY ONLINE FEE PAYMENT<br><br></h2><br>
		<?php
			$flag=0;
		$roll=$_POST["roll"];
		$clg=$_POST["clg"];
		?>
		<form method="post" action="feesadd.php?roll=<?=$roll?>">
		<div class="row w3-grey" align="center">
			<h4><b class="w3-text-white">Student Detail</b></h4>
		</div>
		<br>
		...
		$rs=mysql_query("select * from student where rollno='$roll' and college='$clg' ");
		while($r=mysql_fetch_array($rs)){
			$flag=1;
			?>
			<br>
				<div class="row">
				<label class="col-sm-2" align="right">Student Name: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[2]?></b>
					</div>
					<label class="col-sm-2" align="right">Father Name: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[3]?></b>
					</div>
				</div>
				<br>
				<div class="row">
				<label class="col-sm-2" align="right">Mother Name: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[4]?></b>
					</div>
					<label class="col-sm-2" align="right">Roll no: </label>
					<div class="col-sm-3" align="center">
				...
				<br>
				<div class="row">
				<label class="col-sm-2" align="right">Contact NO: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[8]?></b>
					</div>
					<label class="col-sm-2" align="right">Date of birth: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[5]?></b>
					</div>
				</div>
				<br>
				<div class="row w3-grey" align="center">
			<h4><b class="w3-text-white">Course Detail</b></h4>
		</div>
		<br><br>
		<div class="row">
				<label class="col-sm-2" align="right">Degree: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[6]?></b>
					</div>
					<label class="col-sm-2" align="right">Branch: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[7]?></b>
					</div>
				</div>
				<br>
				<div class="row">
				<label class="col-sm-2" align="right">Year: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[11]+1?></b>
					</div>
					<label class="col-sm-2" align="right">Semester: </label>
					<div class="col-sm-3" align="center">
						<b class="w3-text-blue"> <?=$r[12]+1?></b>
					</div>
				</div>
				<br>
					<br>
				<div class="row w3-grey" align="center">
			<h4><b class="w3-text-white">Type of Fees</b></h4>
		</div>
		<br><br>
				...
				<br>
				<div class="row w3-grey" align="center">
			<h4><b class="w3-text-white">bank account detail</b></h4>
		</div>
		<br><br>
		<div class="row">
				<label class="col-sm-2" align="right">Account number: </label>
					<div class="col-sm-3" align="center">
						<input type="text" class="form-control" name="ac" required="required">
					</div>
					<label class="col-sm-2" align="right">Name of Bank: </label>
					<div class="col-sm-3" align="center">
						<input type="text" class="form-control" name="bk" required="required">
					</div>
				</div>
				<br>
			...
			<div class="row">
				<label class="col-sm-2" align="right">Branch: </label>
					<div class="col-sm-3" align="center">
						<input type="text" class="form-control" name="br" required="required">
					</div>
					<label class="col-sm-2" align="right">IFSC: </label>
					<div class="col-sm-3" align="center">
						<input type="text" class="form-control" name="bk" required="required">
					</div>
				</div>
				<br>
				<br><br><br>
				<input type="checkbox" name="ch1">I agree
		...
		if($flag==0){
			//header("location:fees.php?invalid=1");
			echo '<b class="w3-text-red">'."invalid roll no and college name".'</b>';
		}
		?>
