...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">UPCOMING ACTIVITIES</b></div>
	</div>
		...
		<div class="col-sm-2">
			<img src="university/images/gl6.jpg" class="img-responsive">
		</div>
		
		<div class="col-sm-2">
			<img src="university/images/gl7.jpg" class="img-responsive">
		</div>
		
		<div class="col-sm-2">
			<img src="university/images/gl13.jpg" class="img-responsive">
		</div>
		...
		<div class="row w3-blue" align="center"><b class="w3-text-shadow w3-text-white">MAIN EXAM-2016</b></div><br>
			<div class="panel panel-body">
				<b class="fa fa-search"> </b><b><a href="university/form/guideline.pdf"> General Guidelines exam-2016</a></b><br><br>
				<b class="fa fa-search"> </b><b><a href="university/form/examdate.pdf"> Important date exam-2016</a></b><br><br>
				<b class="fa fa-search"> </b><b><a href="university/form/fees.pdf"> Fees Structure exam-2016</a></b><br><br>
				<b class="fa fa-search"> </b><b><a href="university/form/reevalution.pdf"> Reevalution form</a></b><br><br>
				<b class="fa fa-search">  </b><b><a href="university/form/mainfees.pdf"> Semester and Year Fees Form</a></b><br><br>
			</div>
		</div>
