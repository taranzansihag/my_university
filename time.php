...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">Time-Table</b></div>
	</div>
	<img src="university/images/timetable.jpg" class="img-responsive" width="100%">
	<br><br>
		<div class="container">
		<div class="col-sm-3">
		</div>
		...
		<div class="col-sm-9">
			<div class="row w3-border-bottom w3-border-red">
			 <h1 class="w3-text-red w3-text-shadow">Time Table</h1>
		</div>
		<br><br><br>
			<table class="table">
		    <thead>
			  ...
			  $sn=0;
			   ...
			   while($r=mysql_fetch_array($rs)){
				   ...
				   ?>
					...
					<td><?=$sn?></td>
					<td><?=$r[1]?> (<?=$r[2]?>)</td>
					<td><a href="university/time/<?=$r[1]?><?=$r[2]?>.pdf">download</a></td>
					</tr>
				   <?php
			   }
			  ?>
