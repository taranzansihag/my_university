...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">PLACEMENT PANEL </b></div>
	</div>
	<div clss="row" style="heighgt:300px">
	<img src="university/images/placement2.png" class="img-responsive" width="100%" height="10%"><br>
	
	<div class="container">
	<br><br>
	<div class="row w3-border-bottom w3-border-red">
			 <h1 class="w3-text-red w3-text-shadow">All Student Record</h1>
		</div><br>
		
		 <?php
	  
		include("database.php");
		$rs=mysql_query("select * from st_placement");
		...
		<div class="row w3-border-bottom">
			<div class="col-sm-6">
			<img src="university/stplacement/<?=$r[1]?>.jpg" class="img-responsive img-circle">
			</div>
			<div class="col-sm-6">
			<label>Name:</label><b class="w3-text-shadow"> <?=$r[1]?></b><br>
			<label>fname:</label><b class="w3-text-shadow"> <?=$r[2]?></b><br>
		    <label>package:</label><b class="w3-text-shadow"> <?=$r[4]?></b><br>
			<label>company:</label><b class="w3-text-shadow"> <?=$r[3]?></b><br><br><br>
			</div>
