       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
			...
			<form action="addcompany.php" method="post">
				<div class="row">
					...
					<div class="col-sm-6">
						<input class="form-control" type="text" name="cmp" placeholder="company name" required="required">
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-sm-6">
						<input class="form-control" type="text" name="pkg" placeholder="123.45 lack" required="required">
					</div>
				</div>
				<br>
