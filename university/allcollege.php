			...
			?>
				...
				?>
							  ...
							  <tr class="success">
								...
								<td><?=$C2?></td>
								<td><?=$C3?></td>
								<td><a href="collegedelete.php?name=<?=$C1?>"><img src="images/delete.png" width="20" height="20"></a></td>
							</tr>	
				...
				?>
						...
						<button class="btn btn-success"><a href="collegeform.php">Add College</a></button>
