			...
			<table class="table">
				...
				?>
							  ...
							  <tr class="success">
								<td><?=$C0?></td>
								<td><?=$C1?></td>
								<td><a href="sportdelete.php?id=<?=$C0?>"><img src="images/delete.png" width="20" height="20"></a></td>
				...
				?>
						  ...
						  <br><button class="btn btn-success"><a href="sportform.php"><b>ADD  Sport NEWS</a></b></button>
				</div>
