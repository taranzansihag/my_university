	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red">College Detail</b>
			</div>
				<form method="post" action="addcollege.php">
				 <div class="row">
					<label class="col-sm-3">College:</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="college" placeholder="college name" required="required">
					</div>
				 </div>
				 <br>
				 <div class="row">
					<label class="col-sm-3">College Adderss:</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="cgaddress" placeholder="college address" required="required">
					</div>
				 </div>
				  <br>
				 <div class="row">
					<label class="col-sm-3">College Contact no:</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="contact" placeholder="0123456789" required="required">
					</div>
				 </div>
				 <div align="center">
