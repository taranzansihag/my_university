	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red">Employee Detail</b>
			</div>
			<form enctype="multipart/form-data" method="POST" action="employeeadd.php">
			<br>
				<div class="row">
			...
			<br>
				<div class="row">
					<label class="col-sm-3">Controller:</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="cnt" placeholder="name" required="required">
					</div>
				</div>
					<br>
					<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input class="form-control" type="date" name="date" placeholder="contact" required="required">
					</div>
				</div>
				<br>
				<div class="row">
					...
					<br><button class="btn btn-success"> Add Member </button>
				</form>
				</div></div>
				</div>					
			</div>
