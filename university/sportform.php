	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
			...
			<div class="well well-sm" align="center">
				...
				<form enctype="multipart/form-data" action="addsport.php" method="POST">
				
				<br>
			<?php /*Email<input type="email" name="email" required="required" /><br />*/ ?>
			<label class="w3-text-green">Choose full sport news:</label>
			
			<input class="form-control" type="file" name="photo">
			
			<br>
				<label class="w3-text-green">SPORT NEW'S : </label><textarea name="news" row="3" coloum="100" required="required" class="form-control"></textarea><br>
				<button class="btn btn-primary">add sport news</button>
				</form>
			</div>
			</div></div>
			</div>
