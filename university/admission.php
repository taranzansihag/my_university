	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		   <br>
					...
					<div class="col-sm-2 w3-text-white" align="center">
						...
						<a href="#">Conduct</a><br>
						<a href="#">Exam Form</a><br>
						<a href="#">Reevalution</a><br>
						<a href="#">Addmission Card</a><br>
					</div>
					<div class="col-sm-2 w3-text-white" align="center">
						<b style="text-decoration:underline">FACAULTY</b><br>
		...
		<div class="col-sm-4">
			...
			<div class="col-sm-3">
				...
				<i class="fa fa-search w3-text-red" style="font-size:34px"></i>
		...
		<?php
			if(isset($_GET["mismatch"])){
				echo '<b class="w3-text-red w3-text-shadow">'."invalid roll no".'</b>';
			}
		?>
		...
		<div class="col-sm-4 w3-text-white w3-border-right w3-border-white" align="center">
			...
			<br><br><br>
			<h3 class="w3-text-shadow"><b>Student Wel-Fare Center</b></h3><br><br>
