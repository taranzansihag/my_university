	...
	?>
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
			...
			<?php
		if(isset($_GET["dlt"])){
	    echo '<b class="w3-text-red" style="text-decoration:underline;">'."successfully deleted".'</b>';
		}
		if(isset($_GET["succ"])){
	    echo '<b class="w3-text-red" style="text-decoration:underline;">'."successfully addede".'</b>';
		}
	?>
			...
			<?php
					...
					while($r=mysql_fetch_array($rs)){
					  ...
					  <td><?=$r[0]?></td>
					  <td>
						<a href="depview.php?cnt=<?=$r[1]?>"><b><?=$r[1]?> section</b></a> 
						</td>
					<td><?=$r[2]?></td>
					<td><?=$r[4]?></td>
						<td>
						<a href="vcdelete.php?dlt=<?=$r[2]?>" id="dt"><img src="images/delete.png" width="20" height="20"></a>
					</td>
					</tr>
					 <?php
					}
					?>
					 ...
					 <br>
					 <button class="btn btn-success"><a href="vcform.php"><b>ADD NEW</a></b></button>
					</div>
