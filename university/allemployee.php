			...
			?>
				...
				?>
							  ...
							  <tr class="success">
								...
								<td><?=$C6?></td>
								<td><?=$C7?></td>
								<td><a href="employeedelete.php?degree=<?=$C1?>"><img src="images/delete.png" width="20" height="20"></a></td>
							</tr>	
				...
				?>
						...
						<button class="btn btn-success"><a href="emform.php">Add Employee</a></button>  
			</div>
