	...
	?>
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#A52A2A; height:640px;">
				...
				<b class="w3-text-white"><a href="student.php">ALL MEMBER'S</a></b><br><br>
				<b class="w3-text-white"><a href="allstudent.php ">ALL STUDENT</a></b><br><br>
				<b class="w3-text-white"><a href="addstudent.php">ADD STUDENT</a></b><br><br>
				<b class="w3-text-white"><a href="syllabus.php"></a></b><br><br>
