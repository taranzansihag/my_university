...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
			...
			<div class="col-sm-3">
				...
				<i class="fa fa-link w3-text-red" style="font-size:34px"></i>
				 ...
				 <div class="w3-dropdown-content w3-cyan w3-card-12">
				  <br>
				  <b><a href="gallery.php">Galery</a></b>
		...
		<img src="university/images/fees.jpg" class="img-responsive" width="100%">
	<br><br>
	
		<div class="container responsive">
		<?php
			if(isset($_GET["invalid"])){
				echo '<b class="w3-text-red w3-text-shadow">'."invalid roll no or college name".'</b>';
			}
			
		?>
		<form method="post" action="feesform.php">
		<div class="row">
		...
		$rs=mysql_query("select * from college");
