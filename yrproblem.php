	...
	<div class="container responsive">
		...
		<div class="col-sm-10">
			...
			$email=$_COOKIE["user"];
				...
				$rs=mysql_query("SELECT * FROM problem WHERE froms='$email' OR tos='$email' ") or (mysql_query());
			...
			<div class="panel panel-body">
			 <h3 class="w3-text-red w3-text-shadow" align="center">Your Problem</h3><br>
			<form action="sendmsg1.php" method="post">
				<div class="row">
