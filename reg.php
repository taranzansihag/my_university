...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">SOLVE PROBLEM</b></div>
	</div>
	...
	<div class="container responsive">
		...
		<div class="row" align="center">
			...
			<div class="panel panel-body">
			 <h3 class="w3-text-red w3-text-shadow" align="center">Log in Panel</h3><br>
			 <?php
				if(isset($_GET["same"])){
					echo '<b class="w3-text-red">'."this email id allready available plz other email to sign up".'</b>';
				}
				if(isset($_GET["mismatch"])){
					echo '<b class="w3-text-red">'."password and retype password are not match".'</b>';
				}
			...
			<form method="post" action="signup.php">
				<div class="row">
					...
					<div class="col-sm-6">
					<input class="form-control" type="email" name="email" required="required" paceholder="your name">
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-sm-6">
					<input class="form-control" type="password" name="pass" required="required" paceholder="your name">
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-sm-6">
					<input class="form-control" type="password" name="rpass" required="required" paceholder="your name">
					</div>
				</div>
				<br>
				<div class="row" align="center">
