	...
	<div class="container responsive">
		...
		<?php			
			if(isset($_GET["invalid"])){
					echo '<b class="w3-text-red">'."invalid emailid and password".'</b>';
				}
				?>
				<br>
			...
			<br>
				<div class="row" align="center">
					<a href="reg.php" class="w3-text-red w3-text-shadow">new registration</a>
					
				</div>
			<?php
				if(isset($_GET["succ"])){
					echo '<b>'."your message successfully sent your university".'</b>';
				}
			?>
