...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">VICE CHANCELLOR</b></div>
	</div>
		...
		<div class="row">
		<div class="col-sm-3">
			<img src="university/images/profile.jpg" class="img-responsive img-circle w3-hover-opacity w3-bordered w3-padding">
		</div>
		<div class="col-sm-9">
		
		<span>
		The establishment of the My University, Bikaner at Bikaner marks an important milestone in 
		the development of Higher Education in Rajasthan. The University envisages to develop its campus in terms of 
		academic input and infrastructural facilities as a nucleus and resource centre for development of its affiliated
		colleges as well as to develop its campus teaching through various teaching departments.
		The University has the faculties of Arts, Social Sciences, Science, Commerce, Education and Law.
		<br><br>
		Presently, there are five university teaching departments in the subjects of English, History,
		Environmental Science, Microbiology and Computer Science.

	<br><br>
		The establishment of the My University, Bikaner at Bikaner marks an important milestone
		in the development of Higher Education in Rajasthan. The University envisages to develop its campus in terms of academic  
		</span>
		</div>
		</div>
		<div class="row">
		<span>
		input and infrastructural facilities as a nucleus and resource centre for development of its affiliated 
		colleges as well as to develop its campus teaching through various teaching departments. The University has the 
		faculties of Arts, Social Sciences, Science, Commerce, Education and Law. Presently, there are five university 
		teaching departments in the subjects of English, History, Environmental Science, Microbiology and Computer Science.
	<br><br>
	The establishment of the My University, Bikaner at Bikaner marks an important milestone 
	in the development of Higher Education in Rajasthan. The University envisages to develop its campus in terms 
	of academic input and infrastructural facilities as a nucleus and resource centre for development of its affiliated 
	colleges as well as to develop its campus teaching through various teaching departments. The University has the
	faculties of Arts, Social Sciences, Science, Commerce, Education and Law. Presently, there are five university
	teaching departments in the subjects of English, History, Environmental Science, Microbiology and Computer Science.
