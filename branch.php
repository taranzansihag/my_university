...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">BRANCHES</b></div>
	</div>
	
	
		
		<img src="university/images/branch.jpg" class="img-responsive" width="100%">
		...
		<div class="col-sm-6" align="center">
			...
			<div class="col-sm-6">
					   ...
					   <div class="row w3-border-bottom w3-border-red">
						...
						<h2 class="w3-text-red w3-text-shadow"><?=$r[1]?></h2>
						</div>
					   <br>
					 <?php
							include("database.php");
							$rs1=mysql_query("select * from branch where degree='$r[1]' ");
