...
<script src="university/jquery.js"></script>
  <script>
	...
	<nav class="w3-downnav w3-blue" style="display:none" id="mySidenav">
		...
		<b class="w3-text-shadow">ALL UNDER COLLEGE</b></div>
	</div>
	
	<div clss="row" style="heighgt:300px">
	<img src="university/images/clg.jpg" class="img-responsive" width="100%">
	<br><br>
	<div class="container">
	<div class="col-sm-2"></div>
	<div class="col-sm-10">
	<div class="row w3-border-bottom w3-border-red">
			 <h1 class="w3-text-red w3-text-shadow">All college</h1>
		</div>
		<br><br>
	<table class="table">
	<thead>
